...
export const PALETTE_PROMPT = `Tu es un expert en design système et accessibilité WCAG.
...
export const REVIEW_PROMPT = `Tu es un relecteur expert de présentations pédagogiques.
